...
constexpr std::string_view ANSI_COLOR_RESET =
    "\x1b[0m"; // escape code to reset the color after printing the colored text
// string_view provides a lightweight object that offers read-only access to a
...
template <typename type_store_data> class custom_vertex_1 : public GraphVertex {
...
public:
  ...
  [[nodiscard]] type_store_data get_vertex_name() const { return vertex_name; }
...
using CustomVertex_1 =
    custom_vertex_1<PrimitiveVertexEdges_T::vertex_primitive_1_t>;
using CustomEdge_1 = custom_edge_1<PrimitiveVertexEdges_T::edge_primitive_1_t>;

using CustomVertex_2 =
    custom_vertex_1<PrimitiveVertexEdges_T::vertex_primitive_2_t>;
using Custom_Edge_2 = custom_edge_1<PrimitiveVertexEdges_T::edge_primitive_2_t>;

using CustomVertex_3 =
    custom_vertex_1<PrimitiveVertexEdges_T::vertex_primitive_3_t>;
