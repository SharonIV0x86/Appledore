...
int main() {
  ...
  std::cout << "LAX to ATL: "
            << (AirportsGraph(LAX, ATL) ? "Exists" : "Does not exist") << "\n";
  std::cout << "JFK to DEN: "
            << (AirportsGraph(JFK, DEN) ? "Exists" : "Does not exist") << "\n";
  std::cout << "ATL to LAX: "
            << (AirportsGraph(ATL, LAX) ? "Exists" : "Does not exist") << "\n";
  ...
  std::cout << "NO. of flights starting from " << LAX << " : "
            << AirportsGraph.outdegree(LAX) << "\n";
  std::cout << "NO. of flights ending at " << LAX << " : "
            << AirportsGraph.indegree(LAX) << "\n";
  std::cout << "Total flights to and from " << LAX << " : "
            << AirportsGraph.totalDegree(LAX) << "\n";
